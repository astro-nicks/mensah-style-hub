...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Bespoke West African menswear. Suits, shirts, and trousers hand-tailored in Accra and Lagos." },
      { property: "og:title", content: "Mensah — Tailored Excellence, Rooted in Africa" },
      { property: "og:description", content: "Bespoke West African menswear hand-tailored by master artisans." },
